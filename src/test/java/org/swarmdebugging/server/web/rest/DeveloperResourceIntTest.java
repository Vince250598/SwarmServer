...
import org.swarmdebugging.server.repository.DeveloperRepository;
import org.swarmdebugging.server.repository.search.DeveloperSearchRepository;
...
public class DeveloperResourceIntTest {
    ...
    public void createDeveloper() throws Exception {
        ...
        assertThat(developerEs).isEqualToComparingFieldByField(testDeveloper);
    }
